# For handling response fetching, response streaming, exponential backoffs, etc.
## non-streaming version required when we do compaction/summarization
...
class LLMClient:
    ...
    async def _non_stream_response(self, client: AsyncOpenAI, kwargs: dict[str, Any]) -> StreamEvent:
        ...
        text_delta = None # text_delta because delta refers to change and there will be change in text
        if message.content:
