...
_console: Console | None = None # global singleton instance
...
class TUI:
    def __init__(self, console: Console | None = None) -> None:
        ...
        self._assisstant_stream_open = False
        self._tool_args_by_call_id: dict[str, dict[str, Any]] = {}
        self.cwd = Path.cwd()
    def begin_assistant(self) -> None:
        self.console.print()
        self.console.print(Rule(Text("Assistant", style='assistant')))
        self._assisstant_stream_open = True

    def end_assistant(self) -> None:
        if self._assisstant_stream_open:
            self.console.print()
        self._assisstant_stream_open = False


    def stream_assistant_delta(self, content: str) -> None:
        self.console.print(content, end="", markup=False) # end is empty instead of \n because we don't want to change line for each token
    ...
    def tool_call_complete(
        ...
        if name == "read_file" and success:
            if primary_path:
                ...
                blocks.append(
                    Syntax(code,pl, theme="monokai", line_numbers=True, start_line=start_line, word_wrap=False)
                )
            else:
